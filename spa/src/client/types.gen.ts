...
export type GetCommentsConversationByConvoUrlResponse =
  GetCommentsConversationByConvoUrlResponses[keyof GetCommentsConversationByConvoUrlResponses];
...
export type GetCommentsUserByUsernameResponse =
  GetCommentsUserByUsernameResponses[keyof GetCommentsUserByUsernameResponses];
...
export type GetCommentsByIdRepliesResponse =
  GetCommentsByIdRepliesResponses[keyof GetCommentsByIdRepliesResponses];
...
export type PostCommentsNewResponse =
  PostCommentsNewResponses[keyof PostCommentsNewResponses];
...
export type PostCommentsEditByIdResponse =
  PostCommentsEditByIdResponses[keyof PostCommentsEditByIdResponses];
