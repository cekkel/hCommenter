...
export const ConversationComments = (props: ConversationProps) => {
  const { data: comments, isLoading, error } = useGetCommentsConversationConvoUrl(props.convoUrl);
...
const EmptyComments = () => {
  return (
    <div className="bg-gray-100 p-4 rounded-lg shadow-md">
      <p className="text-gray-600">No comments found for this conversation.</p>
    </div>
  );
}